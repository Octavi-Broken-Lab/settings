...
public class SettingsHomepageOOSActivity extends FragmentActivity implements AppBarLayout.OnOffsetChangedListener {
...
//        setTheme(R.style.ForcedHomepageTheme);
        ...
        final View root = findViewById(R.id.settings_homepage_container_oos);
